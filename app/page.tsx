...
    e.preventDefault();
    ...
    // ============= ⚡️ 1. 디버깅 코드 ⚡️ =============
    // 버튼 클릭 시 Vercel이 환경 변수를 무엇으로 읽고 있는지 콘솔에 출력합니다.
    console.log("handleSubmit triggered");
    console.log("Reading env variable 'NEXT_PUBLIC_API_URL':", process.env.NEXT_PUBLIC_API_URL);
    // ===========================================
...
    const apiUrl = `${process.env.NEXT_PUBLIC_API_URL}/api/financials/${corpCode}?start_year=${startYear}&end_year=${endYear}`;
    ...
    // ============= ⚡️ 2. 디버깅 코드 ⚡️ =============
    // fetch가 호출할 최종 URL을 콘솔에 출력합니다.
    console.log("Final URL to be fetched:", apiUrl);
    // ===========================================
