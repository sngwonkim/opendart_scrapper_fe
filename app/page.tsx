...
                className="w-1/2 p-3 bg-gray-700 rounded-lg border border-gray-600 focus:ring-green-500 focus:border-green-500 transition duration-150"
                disabled={loading}
              >
                {[...Array(15)].map((_, i) => (
...
          <button
            type="submit"
            className="w-full p-4 bg-green-600 rounded-lg font-bold text-lg hover:bg-green-700 disabled:bg-gray-500 transition duration-200 flex items-center justify-center"
            disabled={loading}
          >
            {loading ? (
...
          <p>본 시스템은 인하대학교 디지털전략혁신센터의 교육용 자료입니다.</p>
        </footer>
      </div>
    </main>
  );
